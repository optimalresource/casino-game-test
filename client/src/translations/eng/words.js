...
var word_bank = {
  ...
  connect_wallet_description:
    "To access our casino, you need to connect your Web3 wallet first. This ensures secure and transparent transactions.",
  connect_metamask: "Connect MetaMask",
  connecting_wallet: "Connecting...",
  verifying_wallet: "Verifying...",
  ...
  provider: "Provider",
  wallet_requirements:
    "You need MetaMask or another Web3 wallet installed to continue.",
  wallet_connection_required:
    "Wallet connection is required to proceed with sign-in.",
  wallet_not_connected: "Please connect your wallet first.",
  wallet_connection_error: "Failed to connect wallet. Please try again.",
  wallet_connection_success:
    "Wallet connected! You can now proceed to sign in.",
};
